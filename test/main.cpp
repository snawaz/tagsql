...
const tagsql::test::schema::author_t author{};
const tagsql::test::schema::book_t book{};
const tagsql::test::schema::review_t review{};

using namespace tagsql::test;
...
void test_universal_tags(tagsql::test::data_context & dc)
{
	namespace t=tagsql::test::universal_tags;
...
void test_select(tagsql::test::data_context & dc)
{
	...
	namespace at = tagsql::test::author_tag;
	namespace bt = tagsql::test::book_tag;
	namespace rt = tagsql::test::review_tag;
...
void test_join(tagsql::test::data_context & dc)
{
	using namespace tagsql::test::schema;
	namespace at = tagsql::test::author_tag;
	namespace bt = tagsql::test::book_tag;
