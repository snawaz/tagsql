...
#include <tagsql/schema/tags.h++>
#include <tagsql/named_tuple.h++>

namespace tagsql { namespace schema
{

    //This definition of schema for table 'book'.
    namespace txzi1 = ::tagsql::book_tag;
    ...
    namespace txzi2 = ::tagsql::author_tag;
    ...
    namespace txzi3 = ::tagsql::review_tag;
